...
const gameOptions = {
    streamingPlatform: {
        ...
        image: './Game_Assets/twitch_youtube_tiktok.png',
    ...
    vTuberModel: {
        ...
        image: `./Game_Assets/PNG_2D_3D.png`,
    ...
    characterLore: {
        ...
        image: `./Game_Assets/Gawr_Gura_Lore.png`,
    ...
    assetsOverlays: {
        ...
        image: `./Game_Assets/VTuber_Assets_and_Overlays.png`,
    ...
    socialMedia: {
        ...
        image: `./Game_Assets/Social_Media.png`,
    ...
    debutContent: {
        ...
        image: `./Game_Assets/Plan_your_Debut.png`,
    ...
    vTuberCommunity: {
        ...
        image: `./Game_Assets/Community.png`,
...
function question() {
    ...
    if(currentQ == 1){
        alert(`Your VTuber debut is in 8 Days! Each day, you can choose what to work on to make it a roaring success.<br><br> A VTuber Debut is simply when you stream with your VTuber for the first time. While having an official debut is optional, some VTubers like to amass followers on social media platforms before their debut to have a grander audience. Although on average, VTubers plan their debuts between a few weeks to a couple of months ahead.`);
    } else if (currentQ == 9) {
        alert(`You did it!`)
        playAgain();
        return
...
function startGame() {
    ...
    if (becomeVtuber == true) {
        ...
        document.getElementById(`option-buttons`).innerHTML = '';
        document.body.style.backgroundImage = `url('./Game_Assets/boringlife.jpg')`;
        return
    } 
}
